...
$db_name  = "bolitest_ClassAds";	// Database name
...
$link = mysqli_connect($host, $username, $passpass,$db_name) or die('MySQL DB '.$db_name.' Connection error: '.mysqli_error().' ');
mysqli_select_db($link, $db_name) or die('MySQL DB '.$db_name.' mysqli_select_db error: '.mysqli_error($link).' ');
